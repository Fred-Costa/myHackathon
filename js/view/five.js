...
export let fiveView = {
    show: () => {
        ...
        $("#rate").submit(function (event) {
            ...
            if (answerService.five_step(answer)) {
        ...
        $("#hint").on('click', () => {
            $('#inner').text("Please add something to the beggining of the array")
        })
        $("#home").on('click', () => {
        ...
        $('#inner-content').text('On their journey, Lina meets Fred and Cads, two talented programmers who are discontent with the AIs dominance. To gain their trust, she overcomes two additional challenges: one related to object-oriented programming and another about advanced array manipulation in JavaScript.'+
        'Fred enjoys having a good time, so he managed to bring rum. As a priority, his drinks should come before all others.'+
        'Add Rum to the pile of Drinks. arr = [Orange Juice, Water, Coca-cola]');
    }
}