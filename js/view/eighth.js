...
export let eighthView = {
    show: () => {
        ...
        $("#rate").submit(function (event) {
            ...
            if (answerService.eighth_step(answer)) {
        ...
        $("#hint").on('click', () => {
            $('#inner').text("I need to search my array for something")
        })
        $("#home").on('click', () => {
        ...
        $("#back").on('click', () => {
            ...
            $('#inner-content').text('As a great mind, Bernardo decides to ask Lina to hand him only the words from a string, big or small, every word has their weight. She needs to find in a string her "zen" place.');
    }
}